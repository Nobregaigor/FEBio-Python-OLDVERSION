...
class INPUT_FLAG(Enum):
	R = auto() #	Required
	RA = auto() # Is required, but has alternatives
	O = auto() #  Optional
	
class INPUT_TYPES_ENUM(Enum):
	PATH = auto() 
	STRING = auto() 
	BOOLEAN = auto()
	PYTHON_SINTAX = auto()
...
INPUT_TYPES = {
	...
	POSSIBLE_INPUTS.FEB_FILE: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.FIBER_TABLES_FILE: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.FEB_FOLDER: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.OUTPUT_FOLDER: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.INPUT_FOLDER: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.FEB_NAME: INPUT_TYPES_ENUM.STRING,

	# ADD_PROPERTIES
	POSSIBLE_INPUTS.PROPERTIES_FOLDER: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.SELECTED_PROPERTIES: INPUT_TYPES_ENUM.STRING,
	POSSIBLE_INPUTS.EXCLUDE_PROPERTIES: INPUT_TYPES_ENUM.STRING,

	# CREATE_CURVE
	POSSIBLE_INPUTS.CURVE_NAME: INPUT_TYPES_ENUM.STRING,
	POSSIBLE_INPUTS.CURVE_MODEL: INPUT_TYPES_ENUM.STRING,
	POSSIBLE_INPUTS.CURVE_PARAMS: INPUT_TYPES_ENUM.STRING,
	POSSIBLE_INPUTS.CURVE_FOLDER: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.CURVE_TYPE: INPUT_TYPES_ENUM.STRING,

	# ADD_LOAD,
	POSSIBLE_INPUTS.LOAD_FOLDER: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.LOAD_NAME: INPUT_TYPES_ENUM.STRING,
	POSSIBLE_INPUTS.LOAD_ATTRS: INPUT_TYPES_ENUM.STRING,
	POSSIBLE_INPUTS.LOAD_TYPE: INPUT_TYPES_ENUM.STRING,

	# EXTRACT_GEOMETRY_DATA,
	# None new inputs
	POSSIBLE_INPUTS.GEOMETRY_DATA_FOLDER: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.PATH_TO_MATLAB_FOLDER: INPUT_TYPES_ENUM.PATH,
	POSSIBLE_INPUTS.MATLAB_PARAMS: INPUT_TYPES_ENUM.STRING,

	POSSIBLE_INPUTS.FIBERS_DATA_FOLDER: INPUT_TYPES_ENUM.PATH,

	# CREATE_STORAGE_FOLDER
	POSSIBLE_INPUTS.STORAGE_NAME: INPUT_TYPES_ENUM.STRING,
	POSSIBLE_INPUTS.PATH_TO_STORAGE: INPUT_TYPES_ENUM.PATH,

	# MODIFY PARAMETER
	POSSIBLE_INPUTS.PARAM_VALS: INPUT_TYPES_ENUM.STRING,
	POSSIBLE_INPUTS.SAVE_AS_NEW: INPUT_TYPES_ENUM.STRING,

	# PREPARE_PARAMETER_STUDY
	POSSIBLE_INPUTS.CONFIG_FILE: INPUT_TYPES_ENUM.PATH,

	POSSIBLE_INPUTS.INPUT_FILE: INPUT_TYPES_ENUM.PATH
}
...
COMMAND_INPUT = {
	...
	POSSIBLE_COMMANDS.ADD_PROPERTIES: [
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.FEB_FILE), 
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.INPUT_FILE), 
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.INPUT_FOLDER), 
	...
	POSSIBLE_COMMANDS.CREATE_LOADCURVE: [
		(INPUT_FLAG.R, POSSIBLE_INPUTS.CURVE_NAME), 
		(INPUT_FLAG.R, POSSIBLE_INPUTS.CURVE_MODEL), 
		(INPUT_FLAG.R, POSSIBLE_INPUTS.CURVE_PARAMS),
		(INPUT_FLAG.O, POSSIBLE_INPUTS.CURVE_FOLDER), 
		(INPUT_FLAG.O, POSSIBLE_INPUTS.CURVE_TYPE),
	],
	...
	POSSIBLE_COMMANDS.ADD_LOAD: [
		...
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.INPUT_FOLDER), 
		(INPUT_FLAG.O, POSSIBLE_INPUTS.OUTPUT_FOLDER), 
		(INPUT_FLAG.O, POSSIBLE_INPUTS.LOAD_NAME), 
		(INPUT_FLAG.O, POSSIBLE_INPUTS.LOAD_FOLDER), 
		(INPUT_FLAG.O, POSSIBLE_INPUTS.LOAD_ATTRS), 
	],
	...
	POSSIBLE_COMMANDS.CALCULATE_FIBERS: [
		(INPUT_FLAG.O, POSSIBLE_INPUTS.FEB_NAME), # Name of the file or "all" (all files in geometry data folder)
		(INPUT_FLAG.O, POSSIBLE_INPUTS.GEOMETRY_DATA_FOLDER), 
		(INPUT_FLAG.O, POSSIBLE_INPUTS.OUTPUT_FOLDER), 
		(INPUT_FLAG.O, POSSIBLE_INPUTS.PATH_TO_MATLAB_FOLDER), 
		(INPUT_FLAG.O, POSSIBLE_INPUTS.MATLAB_PARAMS), 
	],
	...
	POSSIBLE_COMMANDS.CREATE_STORAGE_FOLDER: [
		(INPUT_FLAG.R, POSSIBLE_INPUTS.STORAGE_NAME), 
	...
	POSSIBLE_COMMANDS.MODIFY_PARAMETER: [
		(INPUT_FLAG.R, POSSIBLE_INPUTS.PARAM_VALS), 
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.FEB_FILE), 
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.INPUT_FILE), 
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.INPUT_FOLDER),
		(INPUT_FLAG.O, POSSIBLE_INPUTS.SAVE_AS_NEW) 
	],

	# PREPARE_PARAMETER_STUDY
	POSSIBLE_COMMANDS.PREPARE_PARAMETER_STUDY: [
		(INPUT_FLAG.R, POSSIBLE_INPUTS.CONFIG_FILE),
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.FEB_FILE), 
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.INPUT_FILE), 
		(INPUT_FLAG.RA, POSSIBLE_INPUTS.INPUT_FOLDER),
		(INPUT_FLAG.O, POSSIBLE_INPUTS.OUTPUT_FOLDER),
