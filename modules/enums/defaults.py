...
STORAGE_DIR = join("Mesh-Studies", "Mesh_study_4_Passive_HO_TE")
# WORKING_DIR = pathlib.Path().absolute()
WORKING_DIR = "D:\\Igor\\Research_USF\\University of South Florida\\Mao, Wenbin - Igor\\Febio-Models"

# PATH_TO_STORAGE = join(WORKING_DIR.parents[0], STORAGE_DIR)
PATH_TO_STORAGE = join(WORKING_DIR, STORAGE_DIR)
PATH_TO_FEBIOPYTHON = "D:\\Igor\\GitHub\\FEBio-Python"
