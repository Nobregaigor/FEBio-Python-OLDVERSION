...
def format_data_to_write(data):
	data_to_write = " "
	data_to_write += "\t<MeshData>\n"
	data_to_write += '\t\t<ElementData elem_set="Part1" var="mat_axis">\n'
	...
	for row in data.itertuples():
		...
		data_to_write += template.format(_id=fid, _f0=f0, _s0=s0)

	data_to_write += "\t\t</ElementData>\n"
	data_to_write += '\t</MeshData>\n'
